 ...
 * Generated at: 2019-03-11 08:23:57 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<!-- 图片轮播 S-->\r\n");
      out.write("\t\t<div class=\"in exhibition_hall\">\r\n");
      out.write("\t\t\t<div class=\"roundabout_box\">\r\n");
      out.write("\t\t\t\t<ul id=\"image\">\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 图片轮播 E-->\r\n");
      out.write("\t\t<div class=\"course-wrapper\">\r\n");
      out.write("\t\t\t<ul id=\"video\" class=\"course\">\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t\t<a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/source/getAllSource\" class=\"btn\">全部资源</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<script src=\"https://cdn.bootcss.com/roundabout/2.4.2/jquery.roundabout.min.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      ...
      out.write("\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/image/findAllToJsp',\r\n");
      out.write("\t\t\t\t\t\tdataType : \"json\",//预期服务器返回的数据类型\r\n");
      out.write("\t\t\t\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\t\t\t\tlet content = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t$.each(data, function(n, img) {\r\n");
      out.write("\t\t\t\t\t\t\t\tcontent += \"<li><a href='\" + \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\"+img.ilink + \"'target='_blank'><img src='\"+\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\"+img.ilink +\"'></a><span class='text'>\" + img.title + \"</span></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#image\").html(content);\r\n");
      out.write("\t\t\t\t\t\t\t$('.roundabout_box ul').roundabout({\r\n");
      out.write("\t\t\t\t\t\t\t\tduration : 600,//运动速度\r\n");
      out.write("\t\t\t\t\t\t\t\tminScale : 0.6,//非焦点图片的尺寸\r\n");
      out.write("\t\t\t\t\t\t\t\tautoplay : true,//自动播放\r\n");
      out.write("\t\t\t\t\t\t\t\tautoplayDuration : 2000,//自动播放速度\r\n");
      out.write("\t\t\t\t\t\t\t\tminOpacity : 0.2,//最低透明度\r\n");
      out.write("\t\t\t\t\t\t\t\tmaxOpacity : 1,//最高透明度\r\n");
      out.write("\t\t\t\t\t\t\t\treflect : false,//从左向右移动\r\n");
      out.write("\t\t\t\t\t\t\t\tstartingChild : 1,//默认显示第几张图片\r\n");
      out.write("\t\t\t\t\t\t\t\tautoplayInitialDelay : 200,//第一次从第几毫秒开始自动播放\r\n");
      out.write("\t\t\t\t\t\t\t\tautoplayPauseOnHover : true,//鼠标悬停时停止自动播放\r\n");
      out.write("\t\t\t\t\t\t\t\tenableDrag : true\r\n");
      out.write("\t\t\t\t\t\t\t//允许拖拽（针对移动端）\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t//教程\r\n");
      ...
      out.write("\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/source/getHotSource',\r\n");
      out.write("\t\t\t\t\t\tdataType : \"json\",//预期服务器返回的数据类型\r\n");
      out.write("\t\t\t\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tlet content = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t$.each(data.list, function(n, source) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tif(source.bid.bid == 6){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent += \"<li class='course-item' onclick='window.open(\"+'\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/source/lookPic?sid=' + source.sid + '\"'+\")'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"<div class='course-pic'><img src='\" + (\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\"+source.videoImg || \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/img/default-thumbnail.jpg\") + \"'><i class='course-author'>上传者：\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ source.uid.username + \"</i></div>\" + \"<div class='course-label f-light'>\" + source.sname + \"</div></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}else  if(source.bid.bid == 7){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent += \"<li class='course-item' onclick='window.open(\"+'\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/source/lookVid?sid=' + source.sid + '\"'+\")'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"<div class='course-pic'><img src='\" + (\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\"+source.videoImg || \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/img/default-thumbnail.jpg\") + \"'><i class='course-author'>上传者：\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ source.uid.username + \"</i></div>\" + \"<div class='course-label f-light'>\" + source.sname + \"</div></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}else  if(source.bid.bid == 8){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcontent += \"<li class='course-item' onclick='window.open(\"+'\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/source/lookFile?sid=' + source.sid + '\"'+\")'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"<div class='course-pic'><img src='\" + (\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\"+source.videoImg || \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
