					...
					$.ajax({
						...
						success : function(data) {
							...
							$.each(data, function(n, img) {
								content += "<li><a href='" + "${pageContext.request.contextPath }/"+img.ilink + "'target='_blank'><img src='"+"${pageContext.request.contextPath }/"+img.ilink +"'></a><span class='text'>" + img.title + "</span></li>";
							});
							$("#image").html(content);
