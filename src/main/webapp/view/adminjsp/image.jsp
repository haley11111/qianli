...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="page-content">
			<div class="layui-row">
				<a class="layui-btn" href="${pageContext.request.contextPath }/view/adminjsp/uploadImg.jsp">增加幻灯片</a>
				...
				<tbody>
					<c:forEach items="${pageInfo.list }" var="img">
						<tr>
							...
							<td>${img.title}</td>
							<td>
								<img class="list-preview" src="${pageContext.request.contextPath }/${img.ilink }">
							</td>
							<td>${img.ilink }</td>
