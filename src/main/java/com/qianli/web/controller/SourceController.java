...
public class SourceController {
	...
	public String uploadSource(ModelMap map, MultipartFile picture, Source source, int bbid, int uuid)
			throws Exception {
	...
	public String getAllPic(ModelMap map, @RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn,
			Source source, Integer bbid, String username) throws Exception {
	...
	public String getToAdminPicture(ModelMap map,
			@RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn, Source source,
			@RequestParam(required = false, defaultValue = "6", value = "bbid") Integer bbid, String username)
			throws Exception {
		Integer pageSize = 5;// 每页显示记录数
		BaseDict baseDict = baseDictService.findById(bbid);
		source.setBid(baseDict);
	...
	public String getAllPicToAdmFile(ModelMap map,
			@RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn, Source source,
			@RequestParam(required = false, defaultValue = "8", value = "bbid") Integer bbid, String username)
			throws Exception {
		Integer pageSize = 5;// 每页显示记录数
		BaseDict baseDict = baseDictService.findById(bbid);
		source.setBid(baseDict);
	...
	public String getAllPicToAdmVideo(ModelMap map,
			@RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn, Source source,
			@RequestParam(required = false, defaultValue = "7", value = "bbid") Integer bbid, String username)
			throws Exception {
		Integer pageSize = 5;// 每页显示记录数
		BaseDict baseDict = baseDictService.findById(bbid);
		source.setBid(baseDict);
	...
	public String uploadSourceVideo(ModelMap map, MultipartFile video, MultipartFile videoImage, Source source,
			int bbid, int uuid) throws Exception {
	...
	public String getAllVid(ModelMap map, @RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn,
			Source source, Integer bbid) {
		Integer pageSize = 5;// 每页显示记录数
		BaseDict baseDict = baseDictService.findById(bbid);
		source.setBid(baseDict);
		PageInfo<Source> pageInfo = sourceService.findAll(pn, pageSize, source);
	...
	public String getAllVidToCource(ModelMap map,
			@RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn, Source source, Integer bbid) {
		Integer pageSize = 5;// 每页显示记录数
		BaseDict baseDict = baseDictService.findById(bbid);
		source.setBid(baseDict);
		PageInfo<Source> pageInfo = sourceService.findAll(pn, pageSize, source);
	...
	public String getAllSource(ModelMap map,
			@RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn, Source source,
			@RequestParam(required = false, defaultValue = "6", value = "bbid") Integer bbid, String username)
			throws Exception {
	...
	@ResponseBody
	public PageInfo<Source> getVideoToIndex(ModelMap map,
			@RequestParam(required = false, defaultValue = "1", value = "pn") Integer pn) throws Exception {
		Integer pageSize = 8;// 每页显示记录数

		/*
		 * Users users = userService.getUserByUsername(username); source.setUid(users);
		 */
